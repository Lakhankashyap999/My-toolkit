...
export default function EditPdfPage() {
  ...
  const [fontFamily, setFontFamily] = useState<"Helvetica" | "HelveticaBold" | "TimesRoman" | "Courier">("Helvetica");
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      // ✅ Fixed import: use webpack build to avoid canvas error
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      switch (fontFamily) {
        ...
        case "HelveticaBold": font = await pdfDoc.embedFont(StandardFonts.HelveticaBold); break;
