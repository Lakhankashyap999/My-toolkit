...
export default function ResumeMakerPage() {
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // ---------- ATS-friendly colors (dark grey/black) ----------
      const COLOR_NAME = [30, 30, 30];
      const COLOR_SECTION = [30, 30, 30];
      const COLOR_ACCENT = [60, 60, 60];
      const COLOR_BODY = [40, 40, 40];
      const COLOR_META = [90, 90, 90];
      const COLOR_RULE = [120, 120, 120];
